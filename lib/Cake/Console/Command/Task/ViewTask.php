 ...
 * @var array
 */
	public $scaffoldActions = array('index', 'view', 'add', 'edit', 'find_ajax');
 ...
 */
	protected function _interactive() {
		...
		$wannaDoAdmin = $this->in(__d('cake_console', "Would you like to create the views for admin routing?"), array('y', 'n'), 'y');

		$wannaDoSearch = $this->in(__d('cake_console', "Would you like to create the views with Search?"), array('y', 'n'), 'y');
		
		if (strtolower($wannaDoScaffold) === 'y' || strtolower($wannaDoAdmin) === 'y') {
			$vars = $this->_loadController();
			
			if (strtolower($wannaDoSearch) === 'y') {
				$vars['search'] = true;
			}
