...
<!-- 	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
										<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GruposUrl.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GruposUrl.id'))); ?></li>
	...
	<div id="page-content" class="col-sm-12">
		...
		<div class="gruposUrls form">
			...
			<?php echo $this->Form->create('GruposUrl', array('inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
					<h2><?php echo __('Admin Edit Grupos Url'); ?></h2>
