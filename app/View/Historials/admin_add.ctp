<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-12">
		...
		<div class="historiales form p_form">
			...
			<?php echo $this->Form->create('Historial', array('inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
					<h2><?php echo __('Agregar Historial'); ?></h2>
				<hr />
						<div class="row">
...
<div class="form-group col-sm-4">
		<?php echo $this->Form->input('fecha', array('type'=>'text','div' => false, "class" => 'form-control datepicker')); ?>
			...
			<?php echo $this->Form->submit('Agregar', array('class' => 'right btn btn-large btn-primary')); ?>
